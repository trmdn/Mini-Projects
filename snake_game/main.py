...
fruit_position = [random.randrange(1, (display_x//10)) * 10,
...
while True:
    ...
    if snake_position[0] < 0 or snake_position[0] > display_x - 10:
        game_over()
    if snake_position[1] < 0 or snake_position [1] > display_y - 10:
        game_over()
